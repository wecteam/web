    ...
    var o2console = {
        ...
        init: function(){
            ...
            if(window.console&&console.log&&navigator.userAgent.toLowerCase().match(/chrome\/([\d.]+)/)) {
                ...
                var styleBold = "font-weight: bold;color: #e35108;";
                var styleNormal =  "font-size: 12px;color: #e35108;";

                console.log(consoleConfig.staff + consoleConfig.freshTec + consoleConfig.funExp, "color: #e35108;", styleBold, styleNormal, styleBold, styleNormal, styleBold, styleNormal, styleBold, styleNormal);
